...
class NotifyHelper {
  ...
  tz.TZDateTime _nextInstanceOfTenAM(
      int hour, int minutes, int remind, String repeat, String dateTime) {
    final tz.TZDateTime now = tz.TZDateTime.now(tz.local);

    var formattedDate = DateFormat.yMd().parse(dateTime);
  ...
  tz.TZDateTime afterRemind(int remind, tz.TZDateTime scheduledDate) {
    if (remind == 5) {
      ...
      return scheduledDate =
          scheduledDate.subtract(const Duration(minutes: 20));
    } else {
      return scheduledDate;
    }
  }
